...
export function PostCard({ post, isFirst = false }: PostCardProps) {
  return (
    <Card className="group bg-card/50 border-border/40 hover:border-primary/20 gap-3 overflow-hidden border pt-0 pb-3 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
      {post.coverImage && (
